...
public class Conta implements Cadastro {
    ...
    public void depositoDinheiro(final double valor) {
        // TODO: Você precisa implementar este método 
        if (valor <= 0) {
            throw new IllegalArgumentException("Valor inválido! Para fazer deposito, o valor precisa ser maior que 0 (zero).");
        } else {
    ...
    public void setNumero(String numero) {
        ...
        if (numero == null) {
            throw new NullPointerException("Campo nulo inválido! Deve estar no formato 99999-9.");
        }
        this.numero = numero;
    }
